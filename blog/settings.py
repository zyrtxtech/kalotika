...
SECRET_KEY = "django-insecure-l7*u8g4@a!g5#%e1=4*j^vz@l=^7jff54x@eyz^)2#p3a2*8*#"
...
TINYMCE_DEFAULT_CONFIG = {
    ...
    "toolbar": "undo redo | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media | forecolor backcolor emoticons",
}
